...
require_once($CFG->dirroot.'/user/filters/igovt.php');
...
class user_filtering {
    ...
    function user_filtering($fieldnames=null, $baseurl=null, $extraparams=null) {
        ...
        if (has_capability('local/totara_userdeletion:seedeletedusers', $systemcontext)) {
    ...
    function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'deleted':   return new user_filter_yesno('deleted', get_string('deleted', 'local_totara_userdeletion'), $advanced, 'deleted');
            case 'auth':
            ...
            case 'igovtstatus':            return new user_filter_igovt('igovtstatus', get_string('igovtstatus', 'auth_igovt'), $advanced, 'igovtstatus', array('Invited'));
            default:            return null;
        }
    }
